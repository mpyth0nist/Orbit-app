...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-blue-600 flex items-center justify-center p-7">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-1/2 p-8 lg:p-12">
            ...
            <div className="text-center mb-8">
              <h2 className="text-3xl lg:text-4xl font-bold text-blue-600 mb-2">Welcome</h2>
            ...
            <button
              ...
              className="w-full bg-white border-2 border-gray-300 rounded-lg px-4 py-3 flex items-center justify-center gap-3 hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 font-medium text-gray-700"
            >
