...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    english: {
      ...
      noMediaMessage: 'Photos and videos you post will appear here',
      noSaved: 'No saved posts',
      noSavedMessage: 'Posts you save will appear here',
      noLikes: 'No liked posts yet',
      noLikesMessage: 'Posts you like will appear here',
      privateAccount: 'This account is private',
      privateAccountMessage: 'Follow to see their photos and videos.',
      private: 'Private',
    ...
    french: {
      ...
      noMediaMessage: 'Les photos et vidéos que vous publiez apparaîtront ici',
      noSaved: 'Aucun message enregistré',
      noSavedMessage: 'Les messages que vous enregistrez apparaîtront ici',
      noLikes: 'Aucun message aimé pour le moment',
      noLikesMessage: 'Les messages que vous aimez apparaîtront ici',
      privateAccount: 'Ce compte est privé',
      privateAccountMessage: 'Suivez ce compte pour voir ses photos et vidéos.',
      private: 'Privé',
    ...
    arabic: {
      ...
      noMediaMessage: 'الصور ومقاطع الفيديو التي تنشرها ستظهر هنا',
      noSaved: 'لا توجد منشورات محفوظة',
      noSavedMessage: 'المنشورات التي تحفظها ستظهر هنا',
      noLikes: 'لا توجد منشورات أعجبتك بعد',
      noLikesMessage: 'المنشورات التي تعجبك ستظهر هنا',
      privateAccount: 'هذا الحساب خاص',
      privateAccountMessage: 'تابع هذا الحساب لرؤية صوره ومقاطع الفيديو.',
      private: 'خاص',
